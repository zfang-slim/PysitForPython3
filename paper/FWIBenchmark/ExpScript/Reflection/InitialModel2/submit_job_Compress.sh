#!/bin/bash
np=10
RunScript="RE_valid_PQN_Compress.py"
ExpRootDir="/wavedata/Zhilong/ExxonProject/ReflectModel/ExxonMeeting201909/Reflector_PQN2_TestDebug/Exp2_0"
ExpSubDir="/"
ExpDir=$ExpRootDir$ExpSubDir
WaveRootDir="/wavedata/Zhilong/ExxonProject/ReflectModel/ExxonMeeting201909/Reflector_PQN2_TestDebug/Exp2_0"
