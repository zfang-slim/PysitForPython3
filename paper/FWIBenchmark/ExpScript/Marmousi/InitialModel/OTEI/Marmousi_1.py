...
if __name__ == '__main__':
    ...
    for exp_ind in range(len(ALPHA_ALL)-1, len(ALPHA_ALL)):
        ...
        SubDir = '/OTEI_BoxConstraint_SmoothInitial500_CorrectBox'
    ...
    #   comm = MPI.COMM_SELF
        ...
        for i_freq in range(len(freq_bands)):
            ...
            objective = TemporalOptimalTransport(solver, filter_op=filter_op, parallel_wrap_shot=pwrap, transform_mode='envelope', env_p=1.0)
