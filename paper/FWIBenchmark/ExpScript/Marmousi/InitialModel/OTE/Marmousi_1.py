...
if __name__ == '__main__':
    ...
    for exp_ind in range(len(ALPHA_ALL)-1, len(ALPHA_ALL)):
        ...
        SubDir = '/OTEC_BoxConstraint_SmoothInitial500_CorrectBox'
    ...
    #   comm = MPI.COMM_SELF
        ...
        for i_freq in range(len(freq_bands)):
            ...
            objective = TemporalOptimalTransport(solver, filter_op=filter_op, parallel_wrap_shot=pwrap, transform_mode='exponential', exp_a=1.0, auto_expa=False)
