...
if __name__ == '__main__':
    ...
    for exp_ind in range(len(ALPHA_ALL)-1, len(ALPHA_ALL)):
        sfreq=16.0/10.0
        freq_bands=[[sfreq,sfreq+3.0],[sfreq,40.5]]
        ...
        SubDir = '/EILS_StartFreq2_1_4_1Smooth1500_dx20_CorrectBox_50EI'
    ...
    #   comm = MPI.COMM_SELF
        ...
        for i_freq in range(1):
            ...
            # filter_op = None
            objective = TemporalEnvelope(solver, envelope_power=1.0, filter_op=filter_op, parallel_wrap_shot=pwrap)
